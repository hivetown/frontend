    ...
    <div>
        <b-navbar toggleable class=" " >
            <b-navbar-nav class="w-100">
                <b-navbar-item v-for="(category, index) in categories" :key="index" class="py-2"
                    ...
                    <div class="d-flex gap-3 w-100 ">
                        ...
                        <div class="d-flex gap-2 justify-content-center align-items-center">
                            ...
                            }" @click.stop="toggleCategory(category)" style="color: ; font-size: 1.2em;" />
                        </div>
                    ...
                    <b-collapse v-model="category.showSubCategories">
                        <template v-if="category.showSubCategories">
                            <Category :categories="category.subCategories" :depth="depth + 1" />
                        </template>
                    </b-collapse>
                </b-navbar-item>
            </b-navbar-nav>
