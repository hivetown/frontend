<template>
    ...
    <div class="d-flex parent" style="">
        <div class="w-25 d-flex align-items-center" style="">
            ...
            <p><span>20</span> produtos encontrados</p>
        </div>
        ...
        <div class="w-50 d-flex justify-content-end align-items-center" style="gap:2vh;">
            ...
            <div class="d-flex" style="">
                <div class="views-btn">
                    <b-dropdown id="dropdown-1" :text="'Mostrar: ' + amount" class="m-md-2">
                        <b-dropdown-item @click="amount = '50'">50</b-dropdown-item>
                        <b-dropdown-item @click="amount = 'Second Action'">Second Action</b-dropdown-item>
                        <b-dropdown-item @click="amount = 'Third Action'">Third Action</b-dropdown-item>
                    </b-dropdown>
                </div>
                ...
                <div class="views-btn">
                    <b-dropdown id="dropdown-1" :text="'Mostrar: ' + order" class="m-md-2">
                        ...
                        <b-dropdown-item @click="order = 'Second Action'">Second Action</b-dropdown-item>
                        <b-dropdown-item @click="order = 'Third Action'">Third Action</b-dropdown-item>
                    </b-dropdown>
                </div>
