      ...
      <div class="d-flex" style="">
        <div class="views-btn">
          ...
          >
            ...
            <b-dropdown-item @click="amount = 'Second Action'"
              >Second Action</b-dropdown-item
            >
            <b-dropdown-item @click="amount = 'Third Action'"
              >Third Action</b-dropdown-item
            >
          </b-dropdown>
        </div>
        ...
        <div class="views-btn">
          ...
          >
            ...
            >
            <b-dropdown-item @click="order = 'Second Action'"
              >Second Action</b-dropdown-item
            >
            <b-dropdown-item @click="order = 'Third Action'"
              >Third Action</b-dropdown-item
            >
          </b-dropdown>
        </div>
