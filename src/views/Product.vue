  ...
  <div class="d-flex parent">
    ...
    <div class="w-50">
      ...
      <div class="mt-5 d-flex align-items-center gap-3">
        <b-avatar
          v-if="defaultProduct.producer"
          class="nav-item"
          :src="defaultProduct.producer.image.url"
          :alt="defaultProduct.producer.image.alt"
          ...
          <div class="mt-4" style="background-color: ">
            ...
            >
              <router-link :to="'/producer/' + producerProduct.producer.id">
                <b-avatar
                  class="nav-item"
                  :src="producerProduct.producer.image.url"
                  :alt="producerProduct.producer.image.alt"
                  style="
              ...
              <div style="margin-left: 30%; position: absolute">
                <div class="d-flex gap-5 align-items-center">
                  <span
                    ><h5>{{ producerProduct.currentPrice }}€</h5></span
                  >
                  <div>
  ...
  async beforeMount() {
    ...
    if (this.defaultProduct.producer.images) {
      if (this.defaultProduct.producer.images[this.lowestPriceIndex]) {
        this.selectedImage =
          this.defaultProduct.producer.images[this.lowestPriceIndex].url;
        this.selectedImageAlt =
          this.defaultProduct.producer.images[this.lowestPriceIndex].alt;
      }
    }
