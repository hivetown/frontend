...
export const getProducers = (page?: number, pageSize?: number, search?: string) =>
    api.get<Producer[]>("/producers?includeAll=true", { params: { page, pageSize, search } });


export const getProducerId = (producerId: number, search?: string) => 
    api.get<Producer[]>(`/producers/${producerId}?includeAll=true`, { params: { search } });
...
export const updateProducer = (producerId: number, formData: any, search?: string) =>
